          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        ...
                        array('label'=>'Chi siamo', 'url'=>array('/site/page', 'view'=>'about'),'linkOptions'=>array("data-description"=>"gli attori coinvolti"),),
						array('label'=>'Aspetti legali', 'url'=>array('/site/page', 'view'=>'legale'),'linkOptions'=>array("data-description"=>"trattamento dati"),),
						array('label'=>'Registrati', 'url'=>array('/Registration/registration'), 'visible'=>Yii::app()->user->isGuest),
